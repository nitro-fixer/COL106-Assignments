...
def main():
    ...
    route2 = flight_planner.cheapest_route(0, 4, 0, 10)
    route3 = flight_planner.least_flights_cheapest_route(0, 4, 0, 300)
    
    print([flight.flight_no for flight in route1])
    print([flight.flight_no for flight in route2])
    print([flight.flight_no for flight in route3])
    ...
    print([flight.flight_no for flight in expected_route1])
    print([flight.flight_no for flight in expected_route2])
    print([flight.flight_no for flight in expected_route3])
